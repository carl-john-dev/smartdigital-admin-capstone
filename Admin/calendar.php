                ...
                try {
                    ...
                    if (event.date) {
                        if (typeof event.date === "string") {
                            ...
                            dateInput.value = jsDate.toISOString().split("T")[0];
                        }
                    }

                    if (event.startHour && event.startMinute) {
                        document.getElementById('startTime').value =
                            `${event.startHour.padStart(2, "0")}:${event.startMinute.padStart(2, "0")}`;
                    }

                    if (event.endHour && event.endMinute) {
                        document.getElementById('endTime').value =
                            `${event.endHour.padStart(2, "0")}:${event.endMinute.padStart(2, "0")}`;
                    }
