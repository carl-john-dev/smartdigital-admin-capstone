...
<body>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="three-dots-menu">
                    ...
                    <div class="dropdown-menu-custom" id="dotsDropdown">
                        ...
                        <button class="dropdown-item" id="exportLocations">
                            <i class="fas fa-download"></i> Export Locations
                        </button>
                        <button class="dropdown-item" id="printMap">
                            <i class="fas fa-print"></i> Print Map
                        </button>
                        <div class="dropdown-divider"></div>
                        <button class="dropdown-item" id="refreshMap">
                            <i class="fas fa-sync-alt"></i> Refresh
                        </button>
                        <button class="dropdown-item" id="showMapHelp">
    ...
    <!-- ═══════════════════════════════════════════
         PAGE JAVASCRIPT  
    ═══════════════════════════════════════════ -->
    <script nonce="<?= $nonce ?>" type="module" src="backend/location.js"></script>
